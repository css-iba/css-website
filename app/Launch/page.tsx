  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-4 sm:p-12 md:p-24 colour-bg">
      ...
      <div className="self-start mb-4">
        <Link href="/#launch" className="md:-translate-y-14 inline-flex font-text font-semibold items-center px-4 py-2 colour-box-secondary text-gray-900 rounded-lg hover:scale-[1.02] transition-transform duration-200 shadow">
