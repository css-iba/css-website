...
const participantSchema = z.object({
  ...
  participant1_phone: z.string().length(11, 'Phone number must be exactly 11 digits'),
  ...
  participant2_phone: z.string().optional().refine(val => !val || val.length === 11, 'Phone number must be exactly 11 digits'),
  ...
  participant3_phone: z.string().optional().refine(val => !val || val.length === 11, 'Phone number must be exactly 11 digits'),
  ...
  participant4_phone: z.string().optional().refine(val => !val || val.length === 11, 'Phone number must be exactly 11 digits'),
