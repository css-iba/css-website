    ...
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gradient-to-r from-[#fdf6fb] via-[#f3f7fd] to-[#e9f3fc] px-6 py-2.5 sm:px-3.5 sm:before:flex-1 shadow-md">
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p className="text-sm md:text-md text-gray-900 font-text">
          ...
          ProBattle &apos;26 on 24<sup>th</sup> - 25<sup>th</sup> January. <strong>Cipher, Innovate lab, Competitive Programming, Speed Debugging (High School) and Web dev&apos;s max capacity has reached, no more registrations will be accepted.</strong>
        </p>
        <Link
          href="/ProBattle"
