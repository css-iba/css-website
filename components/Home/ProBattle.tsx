  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between py-12 px-4 md:px-12 md:ml-20 gap-8 mt-20 overflow-x-hidden">
      <div className="flex-1 order-1">
        ...
        >   
          <span className="text-amber-500">ProBattle 2026</span> stands as one of our flagship events, meticulously designed to provide participants with opportunities to <span className="text-amber-500">test their skills, explore cutting-edge technologies, and gain insights from industry leaders.
